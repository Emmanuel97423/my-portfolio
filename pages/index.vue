                ...
                <footer class="max-w-md pb-16 text-sm text-slate-500 sm:pb-0">
                    <p>Librement conçu avec
                        <NuxtLink to="https://www.figma.com/"
                            ...
                            target="_blank" rel="noreferrer">Figma</NuxtLink>
                        et codé avec
                        <NuxtLink to="https://code.visualstudio.com/"
                            class="font-medium text-slate-400 hover:text-teal-300 focus-visible:text-teal-300"
                            target="_blank" rel="noreferrer">Visual Studio Code.
                        </NuxtLink>
                        Construit avec
                        <NuxtLink to="https://nuxt.com/"
                            class="font-medium text-slate-400 hover:text-teal-300 focus-visible:text-teal-300"
                            target="_blank" rel="noreferrer">Nuxt.js
                        </NuxtLink>
                        et
                        <NuxtLink to="https://tailwindcss.com/"
                            class="font-medium text-slate-400 hover:text-teal-300 focus-visible:text-teal-300"
                            target="_blank" rel="noreferrer">Tailwind CSS
                        </NuxtLink>
                        déployé avec
                        ...
                        <NuxtLink to="https://www.typescriptlang.org/"
                            class="font-medium text-slate-400 hover:text-teal-300 focus-visible:text-teal-300"
                            target="_blank" rel="noreferrer">TypeScript
                        </NuxtLink>.
